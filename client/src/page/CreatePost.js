...
const CreatePost = () => {
  ...
  const generateImage = async() => {
    if (form.prompt){
      ...
      await axios.post("http://localhost:8080/api/v1/dalle",{
        prompt:form.prompt
      })
      .then((res)=>{
        console.log(res)
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[900px]">Generate an imaginative image through DALL-E AI and share it with the community</p>
      </div>
